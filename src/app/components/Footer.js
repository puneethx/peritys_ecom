          ...
          <div className="space-y-2">
            ...
            <div className="flex">
              <input
                ...
                className="bg-transparent border border-white/30 rounded-l px-4 py-2 w-full focus:outline-none focus:border-white"
              />
              <button className="bg-transparent border border-l-0 border-white/30 rounded-r px-4">
                <svg
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Link href="#">
                <Image
                  src="https://freepngimg.com/download/iphone/68640-play-google-apple-mobile-app-iphone-store.png"
                  alt="App Store"
                  width={120}
                  height={40}
                  className="w-full"
